import { delteproduct, updateProduct, getSellerItems, handlesellerlogin, handlesellerRegister, selleradditems, sellergetprofile, sellerlogout, getProductDetails, sellerorders, sendSellerOtp, verifySellerOtp } from "../controllers/seller.controller.js";
import express from "express";
import {  Sellerisauthenticated } from "../middleware/SellerisAuthenticated.js";
 export const sellerRouter = express.Router();

sellerRouter.post("/send-otp", sendSellerOtp)
...
sellerRouter.get("/profile", Sellerisauthenticated,sellergetprofile)
