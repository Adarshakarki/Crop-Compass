...
import {   handlebuyerlogin, handlesignup, orderhandeler, productdetails, profile, getMyOrders, cancelOrder, sendBuyerOtp, verifyBuyerOtp } from '../controllers/Buyer.controller.js';
...
BuyerRouter.post('/send-otp', sendBuyerOtp);
BuyerRouter.post('/verify-otp', verifyBuyerOtp);
...
BuyerRouter.get('/myorders', Buyerisauthenticated, getMyOrders);
BuyerRouter.patch('/order/:orderId/cancel', Buyerisauthenticated, cancelOrder);